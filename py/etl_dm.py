...
Original file is located at
    https://colab.research.google.com/drive/10r3FQkLVJYMlda7Xx4YjSecOBOv5Qjrp
"""
...
def criar_faixa_etaria(con_dm):
    ...
    cursor.execute("DELETE FROM DIME_FAIXA_ETARIA")
    cursor.executemany(
        "INSERT INTO DIME_FAIXA_ETARIA (SK_Faixa_Etaria, CD_Faixa_Etaria, DS_Faixa_Etaria, DT_Carga) VALUES (?,?,?,?)", faixa)
    con_dm.commit()
    print("\nDIME_FAIXA_ETARIA criada")

def criar_dime_tempo(con_dm):
  cursor = con_dm.cursor()
  cursor.execute("DELETE FROM DIME_TEMPO")
